        ...
        <div className="product-grid">
          {CrxData.products.map((p, i) => (
            ...
            >
              ...
              >
                <div className="pcat" style={{ color: p.color }}>
                  {p.cat[lang]}
                </div>
                <div
                  className="mono"
              ...
              <div className="picon" style={{ background: p.color }}>
                {p.iconText}
              </div>
              {i === 0 && (
                <div
                ...
                >
                  ...
                  <div
                    style={{
                      position: 'absolute',
                      inset: 0,
                      background: 'linear-gradient(180deg, transparent 30%, #0f0d14 95%)',
                    }}
                  />
                </div>
              )}
