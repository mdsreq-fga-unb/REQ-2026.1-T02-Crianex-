...
Cada cerimônia abaixo tem um objetivo específico dentro da ER/FDD e ocorre de forma **síncrona** (reunião com participantes, geralmente gravada) ou **assíncrona** (sem reunião formal — execução, checagem ou feedback enviado por outro canal). Clique em uma cerimônia para ver seu objetivo.

<details className="crianex-change">
<summary><span className="crianex-change__id">Domain Modeling Workshop</span> <span className="crianex-change__sum">Etapa 1 · Develop an Overall Model</span> <span className="badge badge--blue">Síncrona</span></summary>
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Feature Discovery Session</span> <span className="crianex-change__sum">Etapa 2 · Build a Feature List</span> <span className="badge badge--blue">Síncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Iteration Replenishment (macro)</span> <span className="crianex-change__sum">Etapa 3 · Plan by Feature</span> <span className="badge badge--blue">Síncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Replenishment Micro + Commitment</span> <span className="crianex-change__sum">Etapa 4 · Design by Feature</span> <span className="badge badge--blue">Síncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Technical Design Review (TDR)</span> <span className="crianex-change__sum">Etapa 4 · Design by Feature</span> <span className="badge badge--blue">Síncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Kanban Pull Execution</span> <span className="crianex-change__sum">Etapa 5 · Build by Feature</span> <span className="badge badge--gray">Assíncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Feature Build Consolidation</span> <span className="crianex-change__sum">Etapa 5 · Build by Feature</span> <span className="badge badge--gray">Assíncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Refinamento de Requisitos</span> <span className="crianex-change__sum">Etapa 5 · Build by Feature</span> <span className="badge badge--blue">Síncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Partial Client Validation</span> <span className="crianex-change__sum">Etapa 5 · Build by Feature</span> <span className="badge badge--gray">Assíncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Formal Client Validation</span> <span className="crianex-change__sum">Etapa 5 · Build by Feature</span> <span className="badge badge--blue">Síncrona</span></summary>
<div className="crianex-change__body">
...
<details className="crianex-change">
<summary><span className="crianex-change__id">Iteration Artifact Closure</span> <span className="crianex-change__sum">Etapa 5 · Build by Feature</span> <span className="badge badge--blue">Síncrona</span></summary>
<div className="crianex-change__body">
