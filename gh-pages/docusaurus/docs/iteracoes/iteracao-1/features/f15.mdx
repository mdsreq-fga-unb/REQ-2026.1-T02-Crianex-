...
**Descrição:** As páginas institucionais (Missão, Visão, Valores) ficam acessíveis publicamente 24/7 sem exigir autenticação, com disponibilidade mínima de 99% mensal (até ~7h de indisponibilidade/mês), monitorada por verificação periódica de uptime.
