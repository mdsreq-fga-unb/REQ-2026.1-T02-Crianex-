...
| 10/05 | Domain Modeling         | "Na primeira você vai colocar um placeholder lá, tipo já vai estar o FAQ lá, mas vai ser só o placeholder e aí quando for fazer os painéis de administração, você vai colocar lá pra gente poder editar... a gente não vai botar isso no código."                                | Divisão do FAQ em exibição estática inicial na vitrine e posterior controle dinâmico por banco de dados integrado à área do administrador.                                   | <span className="badge badge--green">Sim</span>    |
| 10/05 | Domain Modeling         | "O ideal era que vocês já fizessem com o banco (Supabase) pra não ter retrabalho, senão vão fazer um monte de placeholder aí e depois vai ter que trocar... já faça uma tabela sobre o FAQ relacionado aos produtos."                                                            | Decisão arquitetural de adiantar a modelagem relacional de dados no Supabase paralelamente à montagem das views de frontend da Unidade 2.                                    | <span className="badge badge--green">Sim</span>    |
| 10/05 | Domain Modeling         | "O CRM não tem a ver com contato feito pelo site. Isso tem mais a ver com o nosso time de vendas... coloca lá o cliente na lista fria, passa pra próxima que tá aquecendo o lead, primeira reunião... isso é um processo manual, não tem como automatizar."                      | Estruturação do fluxo comercial interno no formato de quadro Kanban puramente manual para acompanhamento do progresso das prospecções externas.                              | <span className="badge badge--green">Sim</span>    |
