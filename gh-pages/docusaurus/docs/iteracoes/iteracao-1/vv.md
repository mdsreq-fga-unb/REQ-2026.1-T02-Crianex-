...
> **Legenda:** <span className="badge badge--green">Aplicado</span> aplicado no backlog · <span className="badge badge--yellow">Pendente</span> pendente de aplicação · <span className="badge badge--red">Crítico</span> achado crítico · <span className="badge badge--yellow">Atenção</span> achado de atenção
...
| ----------- | ----- | ------------------------------------------------------------------------------------------- | ------ |
| Processo    | MP.01 | Modelo FDD: 100% iterativo → fase de construção iterativa                                   | <span className="badge badge--green">Aplicado</span>     |
| Processo    | MP.02 | Direção da priorização: bottom-up → top-down                                                | <span className="badge badge--green">Aplicado</span>     |
| Escopo      | ES.01 | F02 removida — absorvida por F01                                                            | <span className="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.02 | F05 removida — RF07 reproposto + novo RF para F04                                           | <span className="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.03 | F07 absorvida por F06 — RF18 migra para F06                                                 | <span className="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.04 | F22 — RF42 detalhado em 3 RFs                                                               | <span className="badge badge--yellow">Pendente</span>     |
| Escopo      | ES.05 | F25/F26/F27 — agrupadora dividida em 3 features atômicas                                    | <span className="badge badge--green">Aplicado</span>     |
| Verificação | V.01  | MFA/2FA: decisão de não implementar por solicitação do cliente                              | <span className="badge badge--green">Aplicado</span>     |
| Verificação | V.02  | Conflito de numeração RF53 após mudanças de escopo                                          | <span className="badge badge--yellow">Atenção</span>     |
| Escopo      | ES.06 | F10 — Adicionado RF48 para edição de dados do próprio perfil                                | <span className="badge badge--green">Aplicado</span>     |
| Escopo      | ES.07 | F14 — Adicionado RF49 para consentimento e detalhamento de LGPD                             | <span className="badge badge--green">Aplicado</span>     |
| Escopo      | ES.08 | F15 — Adicionado RF50 para consulta de detalhes de produtos SaaS                            | <span className="badge badge--green">Aplicado</span>     |
| Escopo      | ES.09 | F15 — Adicionado RF51 para consentimento e política de cookies                              | <span className="badge badge--green">Aplicado</span>     |
| Escopo      | ES.10 | F08 — Antigo RF15 refatorado em 3 RFs atômicos (CRUD de templates) e movido de F27 para F08 | <span className="badge badge--green">Aplicado</span>     |
...
| **Status**           | <span className="badge badge--yellow">Pendente</span> Remover F02 e RF03 da rastreabilidade                                                                                                                                                                                                                                                     |
...
| **Status**           | <span className="badge badge--yellow">Pendente</span> Renomear RF07, criar novo RF, remover F05 da rastreabilidade                                                                                                          |
...
| **Status**           | <span className="badge badge--yellow">Pendente</span> Remover F07, mover RF18 para F06 na rastreabilidade                                                                                                                                                 |
...
| **Status**       | <span className="badge badge--yellow">Pendente</span> RF42 atualizado; criar e numerar os 2 novos RFs na rastreabilidade                                                            |
