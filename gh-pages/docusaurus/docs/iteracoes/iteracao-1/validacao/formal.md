...
| 3  | Puxar imagens de capa dos produtos diretamente do site de cada produto                                                | Item de ação #2   | [F12 — Produtos SaaS](/iteracoes/iteracao-1/features/f12) | Aceito — implementar pull automático de imagem de capa              | [#218](https://github.com/mdsreq-fga-unb/REQ-2026.1-T02-Crianex-/issues/218)           | Developer   | <span className="badge badge--gray">Não implementado — IT3 pausada</span> |
| 4  | Reativar login com Google no painel admin                                                                             | Item de ação #3   | [F09 — Autenticar](/iteracoes/iteracao-1/features/f09) | Aceito — reativar OAuth Google                                      | [#219](https://github.com/mdsreq-fga-unb/REQ-2026.1-T02-Crianex-/issues/219)           | Developer   | <span className="badge badge--yellow">Pendente — habilitar provider no Supabase Dashboard</span> |
...
| 7  | Colocar uma visualização da senha durante o login                                                                     | Ata IT1, pauta 2  | [F09 — Autenticar](/iteracoes/iteracao-1/features/f09) | Aceito — toggle de visualização no campo de senha + correção do bug de posicionamento (olho fora da caixa) + maxlength=72 | [#222](https://github.com/mdsreq-fga-unb/REQ-2026.1-T02-Crianex-/issues/222) · [PR #228](https://github.com/mdsreq-fga-unb/REQ-2026.1-T02-Crianex-/pull/228) | Developer   | <span className="badge badge--green">Feito</span> |
| 8  | Implementar "esqueci minha senha" no login, com verificação antecipada da existência do e-mail                       | Ata IT1, pauta 2  | [F09 — Autenticar](/iteracoes/iteracao-1/features/f09) | Aceito — fluxo completo em `/admin/login/esqueci-senha` e `/admin/login/redefinir-senha` via `resetPasswordForEmail` (Supabase Auth), mensagem genérica sem revelar existência do e-mail | [#223](https://github.com/mdsreq-fga-unb/REQ-2026.1-T02-Crianex-/issues/223) · [PR #228](https://github.com/mdsreq-fga-unb/REQ-2026.1-T02-Crianex-/pull/228) | Developer   | <span className="badge badge--green">Feito</span> |
