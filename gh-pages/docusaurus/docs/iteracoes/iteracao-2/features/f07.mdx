...
Não há protótipo de alta fidelidade dedicado a esta feature — a central de notificações foi validada diretamente na Technical Design Review e nas evidências abaixo, sem etapa de prototipagem em Figma/HTML separada.
