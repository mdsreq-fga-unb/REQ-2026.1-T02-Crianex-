...
Protótipo de alta fidelidade do CRM interno (compartilhado entre F19, F20 e F21 — mesmo board Kanban), validado com o cliente antes da implementação. A timeline de interações está na seção de detalhe do card.

<ProtoEmbed path="proto/iteracao-2/PrototipoCrianexCRM/" height={480} label="Abrir protótipo do CRM em tela cheia" />

Ver também: [Página de evidências do protótipo](/iteracoes/iteracao-2/evidencias/prototipo).
