...
A comunicação do projeto segue um modelo **assíncrono por padrão**, com momentos síncronos reservados para as cerimônias de sprint e alinhamentos com o cliente — escolha que leva em consideração que três dos seis integrantes têm disponibilidade limitada (até 4h/semana), tornando reuniões síncronas frequentes inviáveis sem impacto na produtividade.
