...
| **Análise e Consenso** | Características de Produto (CPs), Conjuntos de Funcionalidades (Feature Sets) e Funcionalidades (Features) no formato FDD — `<ação> o <resultado> <por/para> um <objeto>` — com critérios de aceitação no formato *Dado / Quando / Então* |
