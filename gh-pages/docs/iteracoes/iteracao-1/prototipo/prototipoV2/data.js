...
const CrxData = {
      ...
      features: [
        {
          ...
          desc: { pt: "Mais de 12 mil itens classificados por BNCC, dificuldade e habilidade.", en: "Over 12k items classified by curriculum, difficulty and skill." }
        },
        {
          title: { pt: "Correção por IA", en: "AI grading" },
          desc: { pt: "Discursivas avaliadas com modelo fine-tuned e revisão humana opcional.", en: "Essay questions graded by a fine-tuned model with optional human review." }
        },
        {
          title: { pt: "Analytics longitudinal", en: "Longitudinal analytics" },
          desc: { pt: "Acompanhe evolução por habilidade, turma e cohort ao longo do ano.", en: "Track growth by skill, class and cohort across the academic year." }
        },
        {
          title: { pt: "Aplicação multi-canal", en: "Multi-channel delivery" },
          desc: { pt: "Provas online com lockdown, impressas com leitor óptico, híbridas.", en: "Online (lockdown), printed with OMR readers, or hybrid delivery." }
        }
      ]
    },
    {
      ...
      features: [
        {
          ...
          desc: { pt: "Construa regras complexas via UI sem código — combinações, multiplicadores, janelas.", en: "Build complex rules visually — combos, multipliers, time windows." }
        },
        {
          title: { pt: "Catálogo de prêmios", en: "Reward catalog" },
          desc: { pt: "Vouchers, cashback, gift cards e produtos físicos via parceiros.", en: "Vouchers, cashback, gift cards and physical goods via partners." }
        },
        {
          title: { pt: "Leaderboards ao vivo", en: "Live leaderboards" },
          desc: { pt: "Rankings atualizados via WebSocket — sem reload, sem polling.", en: "Rankings updated via WebSocket — no reload, no polling." }
        },
        {
          title: { pt: "Anti-fraude", en: "Anti-fraud" },
          desc: { pt: "Detecção de padrões suspeitos com sinalização automática para auditoria.", en: "Suspicious-pattern detection with automatic audit flagging." }
        }
      ]
    },
    {
      ...
      features: [
        {
          ...
          desc: { pt: "Se WhatsApp falhar, tenta SMS, depois e-mail — você define a cascata.", en: "If WhatsApp fails, try SMS, then email — you define the cascade." }
        },
        {
          title: { pt: "Templates i18n", en: "i18n templates" },
          desc: { pt: "Variáveis, condicionais e versões por idioma em um único template.", en: "Variables, conditionals and per-locale versions in one template." }
        },
        {
          title: { pt: "Segmentação dinâmica", en: "Dynamic segments" },
          desc: { pt: "Audiências calculadas em tempo real a partir do seu warehouse.", en: "Audiences computed in real time against your warehouse." }
        },
        {
          title: { pt: "Webhooks de evento", en: "Event webhooks" },
          desc: { pt: "Receba sent, delivered, opened, clicked, bounced em tempo real.", en: "Receive sent / delivered / opened / clicked / bounced live." }
        }
      ]
    },
    {
  ...
  faqs: [
    {
      cat: "geral",
      q: { pt: "Como funciona a contratação dos produtos Crianex?", en: "How do I subscribe to a Crianex product?" },
      a: {
    ...
    {
      cat: "geral",
      q: { pt: "Os produtos podem ser usados em conjunto?", en: "Can multiple products be used together?" },
      a: {
    ...
    {
      cat: "avali",
      q: { pt: "A correção por IA substitui o professor?", en: "Does AI grading replace teachers?" },
      a: {
  ...
  t: {
    ...
    products: {
      ...
      title: { pt: "Seis produtos. Uma plataforma. Um time.", en: "Six products. One platform. One team." },
      desc: {
    ...
    cta2: {
      title: { pt: "Vamos conversar sobre o seu caso de uso.", en: "Let's talk about your use case." },
      desc: {
    ...
    about: {
      ...
      h1: { pt: "Software house B2B baseada em São Paulo desde 2019.", en: "A B2B software house based in São Paulo since 2019." },
      lede: {
    ...
    contact: {
      ...
      channels: [
        ...
        { k: "address", v: { pt: "Av. Paulista, 1842 · São Paulo", en: "Av. Paulista, 1842 · São Paulo" } }
      ]
    },
    faq: {
